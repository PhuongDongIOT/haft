...
import type {
  ...
  Variant,
} from '@applicaion/theme/types/config';
import type { ComponentTheme, Theme } from '@applicaion/theme/types/theme';
...
} from '@applicaion/theme/backgrounds';
import {
  generateBorderColors,
  generateBorderRadius,
  generateBorderWidths,
  staticBorderStyles,
} from '@applicaion/theme/borders';
import componentsGenerator from '@applicaion/theme/components';
import {
  generateFontColors,
  generateFontSizes,
  staticFontStyles,
} from '@applicaion/theme/fonts';
import { generateGutters, staticGutterStyles } from '@applicaion/theme/gutters';
import layout from '@applicaion/theme/layout';
import generateConfig from '@applicaion/theme/ThemeProvider/generateConfig';
