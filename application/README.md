...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/ZWNpUlKtLN)
...
```sh
npx nx serve applicaion
```

To create a production bundle:

```sh
npx nx build applicaion
```

To see all available targets to run for a project, run:

```sh
npx nx show project applicaion
```
